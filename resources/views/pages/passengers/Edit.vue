...
let form = useForm({
    ...
    seat_number: props.passenger.seat_number,
    arrival: props.passenger.arrival,
    departure: props.passenger.departure,
    ticket_acquired: props.passenger.ticket_acquired,
    age: props.passenger.age,
    ship_id: props.passenger.ship_id,
});

const updateNow = () => {
    Inertia.post(`/passengers/${props.passenger.id}`, {
        _method: "put",
        name: form.name,
        ...
        ticket_acquired: form.ticket_acquired,
        ticket_acquired: form.ticket_acquired,
        age: form.age,
